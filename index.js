...
function CemberinAlani(yaricap, piParametre) {
  return piParametre * Math.pow(yaricap, 2);
}
...
ucebolunenlerintoplami = ucetambolunenler.reduce((toplam, s) => toplam + s, 0);
